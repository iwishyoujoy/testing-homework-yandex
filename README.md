# Как запускать тесты? 
Моя версия ноды - v14.21.3. \
Сначала запустите приложение:
[Как запустить приложение](https://github.com/iwishyoujoy/testing-homework-yandex/blob/master/README.md#%D0%BA%D0%B0%D0%BA-%D0%B7%D0%B0%D0%BF%D1%83%D1%81%D1%82%D0%B8%D1%82%D1%8C) \
Также советую ознакомиться с package.json.
...
# запускаем интеграционные тесты первый раз
npm run test2:first

# запускаем интеграционные тесты с багами (в Git Bash), вместо X - номер бага
BUG_ID=X npm run test2
